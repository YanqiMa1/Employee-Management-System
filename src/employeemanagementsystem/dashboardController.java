...
public class dashboardController implements Initializable {
    ...
    //calculate total number of online employees
    public void homeEmployeeTotalPresent() {

        String sql = "SELECT COUNT(id) FROM employee_info WHERE position='Online'";
    ...
    public void homeChart() {
        ...
        String sql = "SELECT date, COUNT(id) FROM employee GROUP BY date ORDER BY date ASC LIMIT 7";//Date type！！！
    ...
    public void addEmployeeAdd() {
        ...
        String sql = "INSERT INTO employee "
                + "(employeeId,firstName,lastName,gender,phoneNum,position,image,date) "//employeeId type!!!
                + "VALUES(?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            if (addEmployee_employeeID.getText().isEmpty()
                ...
                String check = "SELECT employeeId FROM employee WHERE employeeId = '"//employeeId type!!!
...
//                    prepare.setString(8, String.valueOf(sqlDate));
                    prepare.setTimestamp(8, new Timestamp(sqlDate.getTime()));
                    prepare.executeUpdate();

                    String insertInfo = "INSERT INTO employee_info "
                            + "(employeeId,firstName,lastName,position,salary,date) "//employeeId type!!!
                            + "VALUES(?,?,?,?,?,?)";
...
//                    prepare.setString(6, String.valueOf(sqlDate));
                    prepare.setTimestamp(6, new Timestamp(sqlDate.getTime()));
                    prepare.executeUpdate();
    ...
    public void addEmployeeUpdate() {
        ...
        String sql = "UPDATE employee SET firstName = '"
                ...
                + uri + "', date = '" + new Timestamp(sqlDate.getTime()) + "' WHERE employeeId ='"//sqlDate(xiugaiqian) employeeId type!!!
                + addEmployee_employeeID.getText() + "'";
        ...
        try {
            ...
            if (addEmployee_employeeID.getText().isEmpty()
                ...
                if (option.get().equals(ButtonType.OK)) {
                    ...
                    String checkData = "SELECT * FROM employee_info WHERE employeeId = '"               //employeeId type!!!
                            + addEmployee_employeeID.getText() + "'";
    ...
    public void addEmployeeDelete() {
        ...
        String sql = "DELETE FROM employee WHERE employeeId = '"                                       //employeeId type!!!
                + addEmployee_employeeID.getText() + "'";
        ...
        try {
            ...
            if (addEmployee_employeeID.getText().isEmpty()
                ...
                if (option.get().equals(ButtonType.OK)) {
                    ...
                    String deleteInfo = "DELETE FROM employee_info WHERE employeeId = '"                                      //employeeId type!!!
                            + addEmployee_employeeID.getText() + "'";
    ...
    private String[] positionList = {"NewYork", "Boston", "Oakland", "Seattle","Online"};   //change
...
//
////    	System.out.println("addEmployeeSearch() is called");
//    	
...
//
////            	System.out.println("filter is entered");
//            	
...
//
////                System.out.println("First Name:" + predicateEmployeeData.getFirstName());
//                
//                
...
//    }
    ...
    public ObservableList<employeeData> addEmployeeListData() {
        ...
        try {
            ...
            while (result.next()) {
                employeeD = new employeeData(result.getInt("employeeId"),                                              //employeeId type!!!
    ...
    public void salaryUpdate() {
        ...
        String sql = "UPDATE employee_info SET salary = '" + salary_salary.getText()
                + "' WHERE employeeId = '" + salary_employeeID.getText() + "'";                                           //employeeId type!!!                      
